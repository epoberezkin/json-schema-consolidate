...
function Validator(opts) {
    ...
    if (this._opts.formats) console.warn('skeemas: custom formats not supported');
    ...
    function compile(schema) {
        ...
        return function validate(json) {
            return self.skeemas.validate(json, id || schema);
        };
    }
...
function convertOpts(opts) {
    ...
    _opts.breakOnError = !_opts.allErrors;
    return _opts;
}
